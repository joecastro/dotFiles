...
local KonsoleColorScheme(name, scheme, extended_scheme, wallpaper) = {
    sections: {
...
{
    [scheme.key]: KonsoleColorScheme(scheme.key + " Scheme", scheme.value, null, "/usr/local/google/home/joecastro/Pictures/konsole_gcloud_background.png")
